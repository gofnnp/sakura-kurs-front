...
import { IDateFilter, Page, Product, Purchase, PurchaseInfo } from 'src/app/interface/data';
...
export class OrdersComponent implements OnInit {
  ...
  getOrders() {
    this.api.getUserOrders().subscribe({
      next: (value) => {
        this.purchases = value.values.map((purchase: any) => {
          return { ...purchase, products: JSON.parse(purchase.products) }
        })
  ...
  showPurchaseProducts(products: Product[]) {
